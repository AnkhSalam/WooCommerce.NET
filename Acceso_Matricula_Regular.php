...
?>
      <a href="Boleta_Matricula_NG.php" target="_blank" onClick="window.open(this.href, this.target, 'width=900,height=1000'); return false;"><input type="submit" name="btnGenBoleta" id="btnGenBoleta" value="Generar Boleta"></a>
      
    </p>

</div>
</form>
<div id="apDiv10"><img src="img/OAT.png" width="200" height="190"></div>
</body>
</html>